...
class Bartender:
    def __init__(self, x, y):
        ...
        self.color = GRAY
        self.image = None  # Placeholder for the bartender's image

    def load_image(self, image_path, image_size=(30, 40)):
        """Load the bartender's image from the specified file path and scale it."""
        try:
    ...
    def draw(self, screen):
        """Draw the bartender on the screen."""
        if self.image:
