...
def create_labyrinth_walls():
    ...
    # "Pac-Dots" rectangular areas
    box_positions = [
        (80, 80), (250, 80), (450, 80), (620, 80), 
        (80, 270), (620, 270),
        (80, 460), (250, 460), (450, 460), (620, 460)
    ]
    walls.extend([pygame.Rect(x, y, 100, 60) for x, y in box_positions])

    # T-Shaped structures
    t_shape_positions = [
        (390, 140, 20, 100), (280, 180, 240, 20),
        (390, 360, 20, 100), (280, 400, 240, 20)
    ]
    ...
    center_bar = [
        ...
        pygame.Rect(center_x, center_y, 10, 60),   # Left
        pygame.Rect(center_x + 130, center_y, 10, 60),   # Right
        pygame.Rect(center_x, center_y + 50, 140, 10),  # Bottom
    ]
